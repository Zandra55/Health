...
<div id="content">
    <h2 style="color: teal;">Manage Teachers</h2> 
            ...
            <table border="1">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td><a href="update.php?t_id=<?= $row['teacher_id'] ?>" class="action-btn">UPDATE</a><br><br>
<a href="insert_db.php?t_id=<?= $row['teacher_id'] ?>" class="action-btn delete-btn">DELETE</a></td>
...
<script>
    ...
    function searchTeachers(searchTerm) {
        ...
        xhttp.open("POST", "search_teacher.php", true); 
    ...
    function loadAllTeachers() {
        ...
        xhttp.open("GET", "load_all_teachers.php", true);
        xhttp.send();
    }
</script>
