...
$stmt = $conn->prepare("SELECT * FROM teacher_messages");
$stmt->execute();
...
<head>
    ...
    <title>View Teacher Messages</title>
...
<div class="container">
        ...
        <input type="text" id="search" oninput="searchTeacherMessages()" placeholder="Search">
                ...
                <tbody>
                    <?php while($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <button class="delete-btn" onclick="deleteMessage(<?php echo $row['message_id']; ?>)">Delete</button> <!-- Delete button -->
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
    ...
    <script>
        function deleteMessage(messageId) {
            if (confirm("Are you sure you want to delete this message?")) {
                ...
                xhttp.open("GET", "delete_teacher.php?id=" + messageId, true);
                xhttp.send();
            }
        }
        function searchTeacherMessages() {
